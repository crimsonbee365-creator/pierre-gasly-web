...
<div class="dashboard-welcome">
    <div class="welcome-header">
        <div class="welcome-title">
            <div class="header-kicker">Overview</div>
...
<div class="stats-grid">
    <div class="stat-card stat-primary">
        <div class="stat-header">
            <div class="stat-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 4h7a4 4 0 0 1 0 8H6z"/><path d="M6 12h8"/><path d="M9 4v16"/></svg></div>
    ...
    <div class="stat-card stat-success">
        <div class="stat-header">
            <div class="stat-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 4v4"/><path d="M18 4v4"/><rect x="4" y="6" width="16" height="14" rx="2"/><path d="M4 10h16"/></svg></div>
            <div class="stat-content">
    ...
    <div class="stat-card stat-warning">
        <div class="stat-header">
            <div class="stat-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><circle cx="4" cy="6" r="1"/><circle cx="4" cy="12" r="1"/><circle cx="4" cy="18" r="1"/></svg></div>
            <div class="stat-content">
    ...
    <div class="stat-card stat-info">
        <div class="stat-header">
            <div class="stat-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 7h16v10H4z"/><path d="M4 11h16"/><path d="M9 7v10"/></svg></div>
            <div class="stat-content">
    ...
    <div class="stat-card">
        <div class="stat-header">
            <div class="stat-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M9 3h6"/><path d="M8 6h8l1 12H7z"/><path d="M10 10h4"/></svg></div>
            <div class="stat-content">
    ...
    <div class="stat-card">
        <div class="stat-header">
            <div class="stat-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="8" r="3"/><path d="M5 19a7 7 0 0 1 14 0"/></svg></div>
            <div class="stat-content">
    ...
    <div class="stat-card">
        <div class="stat-header">
            <div class="stat-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="6.5" cy="17.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/><path d="M9 17.5h6l2-5h-6z"/><path d="M9 12.5l-2-3H4"/></svg></div>
            <div class="stat-content">
    ...
    <div class="stat-card">
        <div class="stat-header">
            <div class="stat-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3l7 4v5c0 5-3.5 7.5-7 9-3.5-1.5-7-4-7-9V7z"/><path d="M9 12l2 2 4-4"/></svg></div>
            <div class="stat-content">
