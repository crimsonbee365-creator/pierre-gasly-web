...
<head>
    ...
    <style>
        * {
        ...
        .sidebar-logo {
            width: 56px; height: 56px; margin: 0 auto 12px; border-radius: 18px; display:flex; align-items:center; justify-content:center; background: rgba(255,255,255,0.14); color:#fff; box-shadow: inset 0 0 0 1px rgba(255,255,255,0.15);
        }
        .sidebar-logo img { width: 34px; height: 34px; object-fit: contain; display:block; }
        .chip-icon,.stat-icon svg,.metric-icon svg,.sidebar-logo svg,.order-chip svg{width:18px;height:18px;display:block;}
        .chip-icon{display:inline-flex;align-items:center;justify-content:center;margin-right:8px;vertical-align:-0.18em;}
        .order-chip{display:inline-flex;align-items:center;justify-content:center;margin-right:8px;opacity:.8;}
...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-header">
            <div class="sidebar-logo"><img src="assets/img/pg-logo-no-text.png" alt="Pierre Gasly logo"></div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="analytics.php" class="nav-item <?php echo in_array(basename($_SERVER['PHP_SELF']), ['analytics.php', 'sales.php', 'reports.php']) ? 'active' : ''; ?>">
